...
const blockHref = this.getAttribute("href");
...
const mainBlockImage = document.getElementById("mainBlockImage");
...
mainBlockImage.setAttribute("src", blockHref);
...
const blockCaption = this.getAttribute("title");
